...
- [x] 7. 一覧画面（ListPage）の拡張
- [x] 7.1 年度チェックボックスフィルタを追加する
...
- [x] 7.2 Admin限定のmodel_vitalityフィルタを追加する
...
- [x] 8.4 詳細画面のナビゲーションにversions・model_vitalityを引き継ぐ
