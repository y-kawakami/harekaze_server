...
- [ ] 4. デバッグ API・ページの実装
- [ ] 4.1 (P) 全景バリデーション専用デバッグ API エンドポイントを実装する
...
- [ ] 4.2 (P) 全景バリデーション専用 HTML デバッグページを実装する
...
- [ ] 4.3 既存の元気度判定デバッグページに全景バリデーション結果を追加表示する
...
- [ ] 5. DB マイグレーションの作成
- [ ] 5.1 全景バリデーションログテーブルの Alembic マイグレーションを作成する
