...
async def create_tengusu(
        ...
        for tengus in existing_tengus:
            try:
                ...
                if tengus.image_obj_key:
                    await image_service.delete_image(tengus.image_obj_key)
                if tengus.thumb_obj_key:
                    await image_service.delete_image(tengus.thumb_obj_key)
    ...
    image_key = f"{tree.uid}/tengusu_{random_suffix}.jpg"
    thumb_key = f"{tree.uid}/tengusu_thumb_{random_suffix}.jpg"
